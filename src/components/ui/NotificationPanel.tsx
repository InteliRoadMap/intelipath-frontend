...
import { Bell, X, CheckCircle, Info, AlertTriangle, ArrowLeft, CheckCheck } from 'lucide-react'
...
function NotifIcon({ type }: { type: Notification['type'] }) {
  if (type === 'success')
    return <CheckCircle size={22} className="text-emerald-500 shrink-0 mt-0.5" />
  if (type === 'warning')
    return <AlertTriangle size={22} className="text-amber-500 shrink-0 mt-0.5" />
...
function NotifFullPage({
  ...
  return (
    <div
      ...
      style={{ zIndex: 9999, animation: 'notif-slide-up 0.22s cubic-bezier(0.22,1,0.36,1)' }}
    >
      {/* Header */}
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {isDropdownOpen && (
          <div
            ...
            style={{ top: '100%', zIndex: 9998, animation: 'notif-dropdown-in 0.18s cubic-bezier(0.22,1,0.36,1)' }}
          >
            {/* Dropdown header */}
