    ...
    <div className="relative flex h-full w-full select-none flex-col justify-start overflow-hidden bg-brand-dark/40 p-8 xl:p-12">
      ...
      <div className="relative z-10 my-auto flex flex-col items-center justify-center py-6">
              ...
              >
                ...
                <div
                  className={`flex h-7 w-7 items-center justify-center rounded-lg border shadow-md transition-all duration-300 ${
                    isCompleted
                      ...
                      : isActive
                        ? "bg-brand-cyan text-brand-dark border-brand-cyan shadow-brand-cyan/25 scale-110"
                        : "bg-brand-dark/95 text-slate-500 border-slate-800"
                  }`}
                >
                  {isCompleted ? (
                ...
                <span
                  className={`absolute left-9 top-1/2 -translate-y-1/2 whitespace-nowrap rounded border px-2 py-0.5 text-[10px] font-medium tracking-wide shadow-sm transition-all duration-200 ${
                    isHovered
                      ? "opacity-100 translate-x-1 bg-brand-deep/95 border-brand-cyan/40 text-white font-semibold"
                      : "pointer-events-none opacity-0 translate-x-0 bg-brand-dark/80 border-slate-900 text-slate-300"
                  }`}
                >
                  {node.label}
                </span>
        ...
        <div className="mt-8 flex w-full max-w-[360px] gap-3">
          ...
          <div className="flex flex-1 items-center gap-3 rounded-xl  border-slate-800 p-3 glass-card">
            <div className="rounded-lg  border-brand-indigo/20 bg-brand-indigo/5 p-2 text-brand-blue">
      ...
      <div className="z-10 mt-auto">
        ...
        <div className="mt-4 flex gap-2">
          ...
          />
          <div
            className={`h-1 rounded-full transition-all duration-300 ${view === "register" ? "w-8 bg-brand-indigo" : "w-2 bg-slate-800"}`}
          />
