...
export const SkillGapCard = () => {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 flex flex-col h-full">
      <h3 className="text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">Skill Gap Analysis</h3>
      ...
      <div className="flex-grow w-full min-h-[200px]">
        <ResponsiveContainer width="100%" height="100%">
          <RadarChart cx="50%" cy="50%" outerRadius="70%" data={data}>
            ...
            <Radar name="Your Level" dataKey="A" stroke="#1E50FF" fill="#1E50FF" fillOpacity={0.2} />
            <Radar name="Required" dataKey="B" stroke="#F59E0B" fill="none" strokeDasharray="3 3" />
            <Legend 
