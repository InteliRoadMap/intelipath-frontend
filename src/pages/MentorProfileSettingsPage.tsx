...
export default function MentorProfileSettingsPage() {
  ...
  const navItems = [
    { label: "Dashboard", icon: LayoutDashboard, path: ROUTES.MENTOR_DASHBOARD || "/mentor/dashboard" },
    { label: "Insights", icon: TrendingUp, path: "/mentor/insights" },
              ...
              return (
                <a
                  ...
                  className={`flex items-center gap-2 py-4 -mb-3.5 transition-colors ${
                    isActive
                      ? "border-b-[3px] border-[#6366f1] text-[#6366f1]"
            ...
            <div className="section-card bg-white border border-slate-200/80 rounded-2xl p-6 md:p-8 shadow-[0_18px_45px_rgba(15,23,42,0.04)] hover:border-[#6366f1]/30 transition-colors">
              <div className="flex items-start gap-5 mb-8">
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="absolute -bottom-2 -right-2 w-8 h-8 bg-white text-[#4f46e5] rounded-xl flex items-center justify-center shadow-md hover:scale-110 transition-transform border border-slate-100"
                ...
                <>
                  ...
                  <div className="flex items-center justify-end gap-4 border-t border-slate-100 pt-6">
                    ...
                    <button
                      ...
                      onClick={handleSave}
                      disabled={saving}
                      className="px-6 py-2.5 bg-[#4f46e5] hover:bg-[#4338ca] text-white rounded-xl text-[13px] font-bold transition-all shadow-md shadow-[#4f46e5]/20 disabled:cursor-not-allowed disabled:opacity-70 hover:-translate-y-0.5"
                    >
          ...
          <div className="flex-1 space-y-6">
            <div className="section-card bg-white border border-slate-200/80 rounded-2xl p-6 shadow-[0_18px_45px_rgba(15,23,42,0.04)] hover:border-[#6366f1]/30 transition-colors">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50/80 border border-slate-100">
                  ...
                  <button
                    type="button"
                    className="text-[#6366f1] hover:text-[#4f46e5] bg-white p-2 rounded-lg shadow-sm border border-slate-200 transition-all hover:scale-105"
            ...
            <div className="section-card bg-white border border-slate-200/80 rounded-2xl p-6 shadow-[0_18px_45px_rgba(15,23,42,0.04)] hover:border-[#6366f1]/30 transition-colors">
              ...
              <div className="border border-slate-200/80 rounded-xl p-4 flex items-start gap-4 bg-slate-50/50 hover:bg-white transition-colors group">
                <div className="w-10 h-10 bg-slate-900 rounded-xl flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform shadow-md">
                  <Briefcase size={18} />
                </div>
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="font-bold text-[14px] text-slate-900">LinkedIn</h4>
                    <span className="w-2 h-2 rounded-full bg-slate-300"></span>
                  </div>
                  <p className="text-[12px] text-slate-500 mb-2">
                    Connect to sync your professional experience.
                  </p>
                  <button className="text-[12px] font-semibold text-[#6366f1] hover:underline">
                    Connect LinkedIn
                  </button>
                </div>
              </div>
