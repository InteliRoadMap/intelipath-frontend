...
const orbs = [
  { width: 350, height: 350, color: 'bg-brand-cyan/25',    left: '10%', top: '15%',  duration: 18, delay: 0 },
  { width: 500, height: 500, color: 'bg-brand-indigo/25',  left: '65%', top: '10%',  duration: 24, delay: 1 },
  { width: 420, height: 420, color: 'bg-brand-blue/20',    left: '40%', top: '55%',  duration: 20, delay: 2 },
  { width: 280, height: 280, color: 'bg-brand-cyan/20',    left: '80%', top: '70%',  duration: 15, delay: 1.5 },
]
...
export default function NotFoundPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#0b132b] via-[#0a0f24] to-[#020617] font-sans text-slate-100 select-none">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        {orbs.map((orb, i) => (
          <motion.div
            ...
            animate={{ x: [0, 50, -40, 0], y: [0, -40, 35, 0], scale: [1, 1.12, 0.92, 1] }}
      ...
      <div className="pointer-events-none absolute inset-0 z-10 overflow-hidden">
        <div className="scanline absolute left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-brand-cyan/20 to-transparent" />
      </div>
      ...
      >
        ...
        <div className="relative mb-6 leading-none">
          {/* Base layer */}
          <span className="font-display text-[9rem] sm:text-[11rem] font-extrabold tracking-tighter text-white/90 drop-shadow-2xl"
        ...
        >
          ...
          <div className="relative flex justify-center">
            <span className="px-4 text-xs font-mono text-slate-600 uppercase tracking-widest"
        ...
        >
          {[
            { label: 'Sign In',   path: '/login',    icon: <Compass className="w-3.5 h-3.5" /> },
            { label: 'Register',  path: '/register', icon: <MapPin className="w-3.5 h-3.5" /> },
          ].map((link) => (
            <button
              key={link.path}
