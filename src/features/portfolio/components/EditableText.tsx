...
export const EditableText: React.FC<EditableTextProps> = ({ 
  ...
  if (isEditing) {
    ...
    return multiline ? (
      <textarea {...commonProps} rows={draft.split('\n').length || 1} />
    ) : (
  ...
  return (
    <Component 
      className={`cursor-pointer hover:ring-2 hover:ring-primary-500/50 hover:bg-primary-500/10 rounded transition-all ${className}`} 
